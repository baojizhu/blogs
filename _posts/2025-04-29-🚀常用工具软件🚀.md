...
<body>
    ...
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
        ...
        <p><a href="https://baojizhu.github.io/shared-assets/tools/FreeDownloadManager-6.17.0.4574.exe" download>下载工具：FreeDownloadManager-6.17.0.4574.exe</a></p>
    </div>
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
    ...
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
        ...
        <p><a href="https://baojizhu.github.io/shared-assets/tools/example-tool.zip" download>示例工具下载：example-tool.zip</a></p>
    </div>
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
    ...
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
        ...
        <p><a href="https://baojizhu.github.io/shared-assets/tools/Umi-OCR_Paddle_v2.1.5.7z.exe" download>工具下载：Umi-OCR_Paddle_v2.1.5.7z.exe</a></p>
    </div>
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
    ...
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
        ...
        <p><a href="https://baojizhu.github.io/shared-assets/tools/WPS-Office-Installer.zip" download>WPS下载工具：WPS-Office-Installer.zip</a></p>
    </div>
    <div style="border: 1px solid #ccc; padding: 10px; margin: 10px 0;">
